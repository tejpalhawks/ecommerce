                ...
                <div className="home-desc-center">
                    <Container>
                        <Row className="align-items-center">
                            <Col lg={6}>
                                <div className="home-title mo-mb-20">
                                    ...
                                    <p className="text-white-50 home-desc mb-5">
                                        Ubold is a fully featured premium admin template built on top of awesome
                                        Bootstrap 5, modern web technology HTML5, CSS3 and JavaScript library (React).
                                        It has many ready to use hand crafted components.{' '}
                                    </p>
                            ...
                            <Col lg={{ span: 5, offset: 1 }} md={7} xl={{ span: 4, offset: 2 }}>
                                <div className="home-img position-relative">
                                    <img src={homeImage} alt="" className="home-first-img" />
                                    <img src={homeImage} alt="" className="home-second-img mx-auto d-block" />
