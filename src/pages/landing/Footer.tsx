                    ...
                    <Row className="mb-5">
                        <Col lg={4}>
                            <div className="pe-lg-4">
                                ...
                                <p className="text-muted">A Responsive Bootstrap 5 Web App Kit</p>
                                <p className="text-muted mb-4 mb-lg-0">
                                    Ubold is a fully featured premium admin template built on top of awesome Bootstrap
                                    5, modern web technology HTML5, CSS3 and JavaScript library (React). It has many
                                    ready to use hand crafted components.
                                </p>
                            </div>
                        </Col>
                        <Col lg={2} md={6}>
                        ...
                        <Col lg={2} md={6}>
                            <div className="footer-list">
                                ...
                                <ul className="list-unstyled">
                                    <li>
                                        <Link to="#">
                                            <i className="mdi mdi-chevron-right me-2"></i>Help & Support
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to="#">
                                            <i className="mdi mdi-chevron-right me-2"></i>Privacy Policy
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to="#">
                                            <i className="mdi mdi-chevron-right me-2"></i>Terms & Conditions
                                        </Link>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <Col lg={2} md={6}>
                            <div className="footer-list">
                                ...
                                <ul className="list-unstyled">
                                    ...
                                    <li>
                                        <Link to="#">
                                            <i className="mdi mdi-chevron-right me-2"></i>For Marketing
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to="#">
