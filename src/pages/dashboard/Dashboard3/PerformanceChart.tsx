            ...
            <Card>
                <Card.Body>
                    ...
                    <Row className="mt-4 text-center">
                        <Col className="col-4">
                            <ChartStatistics title="Target" icon="fe-arrow-down" stats="$3.8k" variant="danger" />
                        </Col>
                        <Col className="col-4">
                            <ChartStatistics title="Last week" icon="fe-arrow-up" stats="$1.1k" variant="success" />
                        </Col>
                        <Col className="col-4">
                            <ChartStatistics title="Last Month" icon="fe-arrow-down" stats="$25k" variant="danger" />
                        </Col>
                    </Row>
