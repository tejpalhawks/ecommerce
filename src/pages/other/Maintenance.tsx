...
const Maintenance = () => {
    ...
    useEffect(() => {
        if (document.body) document.body.classList.remove('authentication-bg-pattern');
    }, []);
                    ...
                    <Row className="justify-content-center">
                        <div className="col-11">
                            <div className="text-center">
                                <MaintenanceSvg />
                                <h3 className="mt-4 text-white">We are currently performing maintenance</h3>
                                            ...
                                            <Col key={index} md={4}>
                                                <div className="text-center mt-3 ps-1 pe-1">
                                                    <div className="avatar-md rounded-circle bg-soft-light mx-auto">
                                                        <i
                                                            className={classNames(item.icon, 'font-22', 'avatar-title')}
                                                        ></i>
                                                    </div>
                                                    <h5 className="text-uppercase mt-3 text-white">{item.title}</h5>
