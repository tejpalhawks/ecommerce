...
const RocketSvg = () => {
    return (
        <svg className="svg-rocket mt-md-5 mt-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 83.07909 127.50572">
                    ...
                    <Row className="justify-content-center">
                        <div className="col-11">
                            <div className="text-center">
                                ...
                                <h3 className="mt-4 text-white">Stay tunned, we're launching very soon</h3>
                                <p className="text-white-50">We're making the system more awesome.</p>

                                <Row className="mt-5 justify-content-center">
                                    <Col md={8}>
                                        <Countdown date={Date.parse('2023/02/13')} renderer={renderer} />
                                    </Col>
                                </Row>
                            </div>
                        </div>
