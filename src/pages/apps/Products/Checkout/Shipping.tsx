    ...
    return (
        <React.Fragment>
            <div>
                ...
                <Row>
                    <Col md={6}>
                        <div className="border p-3 rounded mb-3 mb-md-0">
                            ...
                            <p className="mb-2">
                                <span className="fw-semibold me-2">Address:</span> {userData?.shippingAddress?.street} {userData?.shippingAddress?.pincode}
                            </p>
                            <p className="mb-2">
                                <span className="fw-semibold me-2">Phone:</span> {userData?.mobile}
                            </p>
                        </div>
                    </Col>
                ...
                <Row className="mt-4">
                    <Col sm={6}>
                        <Link to="/apps/ecommerce/shopping-cart" className="">
                    ...
                    <Col sm={6}>
                        <div className="text-sm-end mt-2 mt-sm-0">
                            <Link to="/apps/ecommerce/checkout" className="btn btn-success">
                                <i className="mdi mdi-cash-multiple me-1"></i> Confirm Order
                            </Link>
                        </div>
                    </Col>
                </Row>
