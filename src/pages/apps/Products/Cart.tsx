...
import { RemoveFromCart, UserCart } from '../../../helpers/api/APIs';
                                ...
                                <Col lg={8}>
                                    <div className="table-responsive">
                                        <table className="table table-borderless table-centered mb-0">
                                            ...
                                            <tbody>
                                                { userCart && userCart?.map((item:any, idx:any) => {
                                                    return (
                                                        <tr key={idx}>
                                                            <td>
                                                                <img
                                                            ...
                                                            <td>
                                                                ...
                                                                /> */}
                                                                <span className='btn text-white'   >-</span>
                                                                    <span id='itemCount'> {item?.count}</span>
                                                                <span className=' btn text-white'>+</span>
                                                            </td>
                                                            <td id='totalPrice'> Rs.{item?.productId?.price * item?.count}</td>
                                                            <td>
                                                                <span
