...
const Task = ({ task, selectTask }: { task: TaskItemTypes; selectTask: (task: TaskItemTypes) => void }) => {
                        ...
                        <div className="mt-3 mt-sm-0">
                            <ul className="list-inline font-13 text-end">
                                <li className="list-inline-item pe-1">
                                    <i className="mdi mdi-calendar-month-outline font-16 me-1"></i> {task.due_date}
                                </li>
                                <li className="list-inline-item pe-1">
