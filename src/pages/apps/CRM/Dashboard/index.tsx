...
const Dashboard = () => {
    return (
        <>
            ...
            <Row>
                <Col lg={6} xl={3}>
                    <Statistics icon="fe-layers" variant="blue" stats="12008" description="Campaign Sent" />
                </Col>
                <Col lg={6} xl={3}>
                    <Statistics icon="fe-award" variant="success" stats="7410" description="New Leads" />
                </Col>
                <Col lg={6} xl={3}>
                    <Statistics icon="fe-delete" variant="danger" stats="2125" description="Deals" />
                </Col>
                <Col lg={6} xl={3}>
                    <Statistics
                        icon="fe-dollar-sign"
