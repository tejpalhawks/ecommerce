            ...
            <Card>
                <Card.Body>
                    <div className="d-flex align-items-start mb-3">
                        <img className="d-flex me-3 rounded-circle avatar-lg" src={personalDetails.profile} alt="" />
                        <div className="w-100">
                            <h4 className="mt-0 mb-1">{personalDetails.name}</h4>
                            <p className="text-muted">{personalDetails.position}</p>
                            <p className="text-muted">
                                <i className="mdi mdi-office-building"></i> {personalDetails.company}
                            </p>
                    ...
                    <div>
                        ...
                        <h4 className="font-13 text-muted text-uppercase mb-1">Date of Birth :</h4>
                        <p className="mb-3">
                            {' '}
                            {personalDetails.dob} ({personalDetails.age} Years)
                        </p>

                        <h4 className="font-13 text-muted text-uppercase mb-1">Company :</h4>
                        ...
                        <h4 className="font-13 text-muted text-uppercase mb-1">Updated :</h4>
