...
const ProjectDetail = () => {
    ...
    return (
        <React.Fragment>
            ...
            <Row>
                <Col md={6} xl={3}>
                    <Statistics icon="fe-list" variant="primary" stats="942" description="Total Tasks" />
                </Col>
                <Col md={6} xl={3}>
                    <Statistics
                ...
                <Col md={6} xl={3}>
                    <Statistics icon="fe-users" variant="info" stats="17" description="Total Team Size" />
                </Col>
                <Col md={6} xl={3}>
                    <Statistics icon="fe-clock" variant="warning" stats="412" description="Total Hours Spent" />
                </Col>
            </Row>
