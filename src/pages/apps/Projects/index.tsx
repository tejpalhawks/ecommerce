        ...
        <Card className="project-box">
            <Card.Body>
                ...
                <p className="text-muted text-uppercase">
                    <i className="mdi mdi-account-circle"></i> <small>{project.companyName}</small>
                </p>
                        ...
                        return (
                            ...
                            >
                                <Link to="#" className="avatar-group-item">
                                    <img src={member.image} className="rounded-circle avatar-sm" alt="" />
                                </Link>
                            </OverlayTrigger>
                        );
                    })}
                ...
                <ProgressBar now={project.progress} className="mb-1" style={{ height: '7px' }} />
            </Card.Body>
        </Card>
    );
};
