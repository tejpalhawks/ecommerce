            ...
            <Card>
                <Card.Body>
                    ...
                    <div className="list-group list-group-flush mt-2 font-15">
                        ...
                        >
                            <i className="mdi mdi-image-filter-black-white font-16 me-1"></i> News Feed
                        </Link>
                        <Link to="#" className="list-group-item list-group-item-action border-0">
                            <i className="mdi mdi-forum font-16 me-1"></i> Messages
                        </Link>
                        <Link to="#" className="list-group-item list-group-item-action border-0">
                            <i className="mdi mdi-calendar-month-outline font-16 me-1"></i> Events
                        </Link>
                        <Link to="#" className="list-group-item list-group-item-action border-0">
                            <i className="mdi mdi-account-multiple-outline font-16 me-1"></i> Friends
                        </Link>
                        <Link to="#" className="list-group-item list-group-item-action border-0">
                    ...
                    <h6 className="font-13 text-muted ps-3 my-3 text-uppercase">Pages you Like</h6>

                    <div className="px-2">
                        <div className="d-flex align-items-start mb-2">
                            <div className="avatar-xs bg-success rounded-circle">
                                <span className="avatar-title font-14 fw-bold text-white">F</span>
                            </div>
                        ...
                        <div className="d-flex align-items-start mb-2">
                            <div className="avatar-xs bg-warning rounded-circle">
                                <span className="avatar-title font-14 fw-bold text-white">U</span>
                            </div>
                            <div className="w-100 ps-2">
                                <h5 className="mt-1 mb-0 font-family-primary fw-semibold">
                                    <Link to="#" className="text-reset">
                        ...
                        <div className="d-flex align-items-start mb-2">
                            <div className="avatar-xs bg-info rounded-circle">
                                <span className="avatar-title font-14 fw-bold text-white">W</span>
                            </div>
                            <div className="w-100 ps-2">
                                <h5 className="mt-1 mb-0 font-family-primary fw-semibold">
                                    <Link to="#" className="text-reset">
