...
export const loginUser = (username: string, password: string ,captcha: string): AuthActionType => ({
...
export const signupUser = (fullname: string, email: string, password: string, regcaptcha: string): AuthActionType => ({
    type: AuthActionTypes.SIGNUP_USER,
    payload: { fullname, email, password, regcaptcha },
});
